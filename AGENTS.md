...
5. Load the founder's own family's real documents — doubles as the real eval set (see below). Not started; capture is now pleasant enough to actually do this (#4 done).
