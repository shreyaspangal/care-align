# CareAlign v1 — Content Log (archived)

> Read-only history of the v1 build journey (coordinator/patient role-model era, 2026-06-15 → 2026-07-13), superseded by the v2 reset on 2026-07-15. Moved here unedited when the live log was split. New entries go in `docs/CONTENT_LOG.md` — never here. Phase numbers below are v1 phases and do not correspond to v2 phases.
